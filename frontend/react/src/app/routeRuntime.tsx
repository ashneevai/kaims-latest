...
export interface IncidentsRouteRuntime { rows: IncidentRow[]; loading: boolean; error: string; application: string; filters: IncidentFilters; refresh: () => void; updateFilter: (name: keyof IncidentFilters, value: string) => void; open: (row: IncidentRow, stage?: string) => void; }
